...
func NewExcel(filename string) (*excel.FileData, error) {
...
// NewExcelFromBinary 从文件读取xlsx，Deprecated, use excel.NewExcel
// func NewExcelFromBinary(bs []byte, filename string) (*excel.FileData, error) {
// 	return excel.NewExcelFromBinary(bs, filename)
// var err error
// var e *ExcelData
