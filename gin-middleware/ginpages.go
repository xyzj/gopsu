...
func Page403(c *gin.Context) {
	...
	c.String(http.StatusForbidden, template403)
}
...
func Page500(c *gin.Context) {
	c.Header("Content-Type", "text/html")
	c.String(http.StatusServiceUnavailable, template500)
}
